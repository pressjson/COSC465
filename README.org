...
This is my solution for COSC 465. This class uses [[https://github.com/mit-pdos/xv6-riscv][Xv6]]. These are my solutions.

The file ~README~ is required to ~make qemu~. Thus, before building for the first time, run

#+begin_src shell
ln -s README.org README
#+end_src
